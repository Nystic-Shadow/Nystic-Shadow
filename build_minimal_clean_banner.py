...
def build_minimal_svg(is_dark=True):
  ...
  <g transform="translate(255, 65)">
    ...
    <!-- Main Hero Name & Concise Subtitle (Till 17 y/o as requested) -->
    ...
    <!-- Concise Skill Pills Grid (Uncluttered) -->
    ...
    <g transform="translate(0, 205)">
      ...
      <text x="42" y="28" fill="{text_main}" font-size="12.5" font-weight="700" font-family="'Segoe UI', sans-serif">STATUS: <tspan fill="{accent_green}">BUILDING &amp; AUTOMATING</tspan></text>
...
with open(r'C:\Users\SAZUZ\Nystic-Shadow\dark.svg', 'w', encoding='utf-8') as f:
    f.write(build_minimal_svg(is_dark=True))

with open(r'C:\Users\SAZUZ\Nystic-Shadow\light.svg', 'w', encoding='utf-8') as f:
    f.write(build_minimal_svg(is_dark=False))

print("Clean minimal uncluttered SVGs built successfully!")
